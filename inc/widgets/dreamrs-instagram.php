...
----------------------------------------*/
class dreamrs_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('dreamrs_instagram_photo',esc_html__('[ Dreamrs ] Intagram Photo','dreamrs'),array(
			'description' => esc_html__('Dreamrs Instagram Photo Widget','dreamrs'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'dreamrs');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'dreamrs'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'dreamrs'); ?></label>
...
if(!function_exists('dreamrs_instagram_widgets')):
	function dreamrs_instagram_widgets(){
		register_widget('dreamrs_instagram_photo');
	}
	add_action('widgets_init','dreamrs_instagram_widgets');
endif;
