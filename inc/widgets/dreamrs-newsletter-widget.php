...
class Dreamrs_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Dreamrs ] Newsletter Form', 'dreamrs' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'dreamrs' ), )
        );
    ...
    echo wp_kses_post( $args['before_title'] . $title . $args['after_title'] );
        ...
        <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="<?php echo esc_url( $actionurl ); ?>" method="post" class="form-inline subscribe_form relative mail_part">
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'dreamrs' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'dreamrs'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'dreamrs'); ?> </p>
...
} // Class dreamrs_newsletter_widget ends here


// Register and load the widget
function dreamrs_newsletter_load_widget() {
	register_widget( 'Dreamrs_newsletter_widget' );
}
add_action( 'widgets_init', 'dreamrs_newsletter_load_widget' );