(function( $ , api){
    ...
    api.section( 'dreamrs_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'dreamrs_about_section' , function( section ){
    ...
    api.section( 'dreamrs_blog_section' , function( section ){
    ...
    api.section( 'dreamrs_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-dreamrs_contact_custom_formshortcode'),
                selector = $('#_customize-input-dreamrs_contact_formshortcode');
    ...
    // General section
    api.section( 'dreamrs_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#dreamrs_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-dreamrs_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-dreamrs_preloader_color' );
            ...
            var $backtotop          = $( '#dreamrs_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-dreamrs_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-dreamrs_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'dreamrs_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#dreamrs_footer_widget_toggle');
