...
// image default alt
if( !function_exists( 'dreamrs_img_default_alt' ) ){
	function dreamrs_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'dreamrs_img_tag' ) ){
	function dreamrs_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = dreamrs_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'dreamrs_anchor_tag' ) ){
	function dreamrs_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'dreamrs_heading_tag' ) ){
	function dreamrs_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'dreamrs_paragraph_tag' ) ){
	function dreamrs_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'dreamrs_other_tag' ) ){
	function dreamrs_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'dreamrs_button_element ' ) ){
	function dreamrs_button_element( array $args ){
